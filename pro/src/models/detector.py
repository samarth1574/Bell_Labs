...
class DenseObjectDetector:
    ...
    def load_model(self) -> None:
        ...
        if self.use_custom_anchors:
            ...
            # Dynamically determine number of feature maps from the model's existing RPN
            num_feature_maps = len(self.model.rpn.anchor_generator.sizes)
            
            # Tiny base sizes for dense overlapping objects
